...
export const PRICE_BASIS =
  'That is where a site starts, and it is what most of them cost. Booking, ordering, a shop, the tools behind them, the ad tracking, and the monitoring are built as part of the site rather than billed on top of it. What moves the price is how big the whole project is, and you see that number and agree to it before any work begins.'
