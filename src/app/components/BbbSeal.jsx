...
export default function BbbSeal({ width = 128, className = '' }) {
  ...
  return (
    <a
      ...
      className={`border-hair inline-flex w-fit rounded-[var(--r-control)] border bg-white p-2 transition-colors duration-200 hover:border-[color:var(--bbb-blue)] ${className}`.trimEnd()}
    >
      <img
        src={BBB_SEAL_SRC}
