...
/**
 * The standing label above a panel's heading, and the heading itself.
 *
 * Two panels inside the configurator set the same two things, and holding them
 * apart is how one of them ends up a size away from the other. They sit beside
 * the block classes because they answer the same question: what a part of the
 * configurator is called, and how the type that calls it is set.
 */
