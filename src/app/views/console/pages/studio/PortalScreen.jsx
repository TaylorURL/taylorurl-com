 ...
 * surfaces in the portal's own order.
 *
 * The first carries no parameter, so the plain address of the section is its
 * front - the same rule every other console section's views follow.
 */
export const PORTAL_VIEWS = PORTAL_SURFACES.map(one => ({ key: one.key, label: one.label }))
 ...
 * layout, because the same five screens are worked from two places: a
 ...
 * the way back is the tab marked Portal, which is on screen at every width.
 *
      ...
      <header className="staff-head">
        <div className="staff-nav">
          <ViewNav
            ...
            // who read a business on the list and then opened the handbook would
            // come back to the call screen holding somebody they had finished
            // with.
