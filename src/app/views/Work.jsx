          ...
          <div className="grid gap-8 lg:grid-cols-2">
            {PROJECTS.map((project, i) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="group overflow-hidden rounded-2xl border border-gray-200 bg-white transition-all duration-300 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-500/5"
              >
                <div className="p-8">
      ...
      <section className="border-t border-gray-200 bg-gradient-to-b from-gray-50 to-white py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <Link
              to="/pricing"
              className="group inline-flex items-center gap-2 rounded-xl bg-blue-600 px-8 py-4 font-semibold text-white shadow-lg shadow-blue-600/25 transition-all duration-300 hover:scale-105 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/30"
            >
              Get a Quote
