 ...
 * required. Used as the card preview; the placeholder swatch shows until the
 * image loads and remains in place if the request fails.
 */
const SCREENSHOT_ENDPOINT = 'https://image.thum.io/get/width/1280/crop/800'
