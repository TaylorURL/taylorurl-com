        ...
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          <div>
            <h2 className={`mb-4 ${SECTION_H2}`}>
              Most customers <span className="logo-wave-dark">search first</span>
            </h2>
            <p className="mb-8 text-base text-gray-600 sm:text-lg">
              Local customers start on Google. Without a website to find, they call the next
              business that comes up.
            </p>
