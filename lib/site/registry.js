...
export const taylorurl = {
  ...
  logoAlt: 'TaylorURL, a small team bringing customers to local businesses in Baytown, TX',

  footerBlurb:
    'A small team bringing customers to plumbers, barbers, restaurants, and contractors around ' +
    'Baytown, Houston, and the rest of Southeast Texas. We build the site and keep it working.',

  head: {
    homeTitle: 'Websites That Bring Customers In | Baytown, TX | TaylorURL',
    description:
      'A small team in Baytown, TX bringing customers to shops, restaurants, trades, and pros around Houston. Custom sites built to get found on Google.',
    image: '/og.png',
    imageAlt:
      'A small team bringing customers to local businesses: design, build, hosting, and getting found on Google, for shops and trades around Baytown and Houston.',
  },
  ...
  installDescription:
    'A small team bringing customers to shops, restaurants, trades, and independent pros around Baytown and Houston.',
  ...
  // The ad account, and the two actions in it this site can honestly fire. It
  ...
  llmsIntro:
    'TaylorURL LLC is a small team of web designers, developers, and local-search ' +
    'specialists in Baytown, Texas. We bring customers to local businesses around Baytown ' +
    'and Houston: shops, restaurants, trades, and independent pros. We design, build, and ' +
    'look after the site that does it. You get a price for your project after a ' +
    'short conversation about what it needs.',
...
export const taylorwebsite = {
  ...
  footerBlurb:
    ...
    'happened, and outbound email run from a domain of your own. A small team does the work.',

  head: {
    homeTitle: 'Software Engineering, Tracking Repair and Outbound | Taylor',
    description:
      'Custom software, conversion tracking that reports what it should, and done-for-you outbound. Built and run by a small team of engineers, for companies anywhere.',
  ...
  // No ad account either, and the three nulls are what keep it that way. A
  ...
  //
  // Everything absent is absent for a reason worth naming: the payment link and
  // the Stripe webhook because nothing is sold here; the newsletter and the eight
  ...
  llmsIntro:
    'Taylor is a small team of engineers. We build custom software to order, repair ' +
    'conversion tracking so ad spend is measured against the leads that came in, and run ' +
    'outbound email from a sending domain registered for the client. The work is done for ' +
    'companies anywhere and is quoted per project.',
