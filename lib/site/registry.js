 ...
 * `scripts/check-site-key.js` refuses a record that is missing a field the other
 * one carries.
 */
...
export const taylorurl = {
  ...
  // projects register all nine schedules, because `vercel.json` is read by the
  ...
  llmsIntro:
    'TaylorURL LLC is Trenton Taylor, a web designer in Baytown, Texas. He designs, builds, and ' +
    'looks after custom websites for local businesses around Baytown and Houston: shops, ' +
    'restaurants, trades, and independent pros. A site starts at $1,000 up front and $99 a ' +
    'month to run.',
 ...
 *
 * `scripts/check-site-key.js` asserts this list and `SITES` name the same sites,
