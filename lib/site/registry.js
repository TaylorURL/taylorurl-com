...
export const taylorurl = {
  ...
  head: {
    homeTitle: 'Websites That Bring Customers In | Baytown, TX | TaylorURL LLC',
    description:
      'A small team in Baytown, TX that brings customers to shops, restaurants, trades, and local pros around Houston. Custom sites from $1,000, built to get found on Google.',
    image: '/og.png',
    imageAlt:
  ...
  llmsIntro:
    ...
    'look after the site that does it. A site starts at $1,000 up front and $250 a ' +
    'month to run.',
...
export const taylorwebsite = {
  ...
  head: {
    ...
    description:
      'Custom software, conversion tracking that actually reports what it should, and done-for-you outbound. Built and run by a small team of engineers, for companies anywhere.',
