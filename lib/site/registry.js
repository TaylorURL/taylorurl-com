...
export const taylorurl = {
  ...
  head: {
    ...
    description:
      'A small team in Baytown, TX bringing customers to shops, restaurants, trades, and pros around Houston. Custom sites from $1,000, built to get found on Google.',
    image: '/og.png',
    imageAlt:
