 ...
 *
 * `vercel.json` holds ten crons and the platform reads it before any build runs,
 * so both projects register all ten and there is no way to key that file. Every
