...
export const CARDS = [
  {
    ...
    to: '/',
    alt: 'Be the one they call. I build the websites that get the click, for shops around Baytown and clients anywhere.',
  },
  {
    key: 'say-phone-first',
  ...
  },
  {
    ...
    to: '/console/status',
    alt: 'When something breaks, I know before you call. Every site I look after reports its uptime and its errors to a page anyone can open.',
  },
  {
    key: 'say-one-person',
  ...
  },
  {
    ...
    to: '/contact',
    alt: 'Ready to get started? Tell me about the business and what you need. Reply within 24 hours, no sales pitch, honest answers.',
  },
  {
    key: 'say-stay-focused',
    file: 'say-stay-focused.png',
    to: '/services',
    alt: 'I keep it online, fast, and safe, so you can stay focused on running the business.',
  },
  {
    key: 'process',
    file: 'process.png',
    to: '/process',
    alt: 'How it works, in three steps. One, get in touch. Two, I build it. Three, go live.',
  },
  {
    key: 'included',
    file: 'included.png',
    to: '/services',
    alt: 'Every site I build is built for the phone first, carries a score you can check yourself, is watched after launch, and is one person start to finish.',
  },
  {
    key: 'trades',
    file: 'trades.png',
