 ...
 * screens and left. A day later this asks what stopped them and puts half the
 ...
 * environment or a database client. `scripts/preview-emails.mjs` renders them
...
export function followUpMessage({ trade = '', step = 0, code, expires, startUrl, unsubscribeUrl }) {
  ...
  const opening = trade
    ? `You picked ${trade.toLowerCase()} on my site and got as far as ${stoppedAt(step)}.`
    : `You started a website on my site and got as far as ${stoppedAt(step)}.`
  ...
  const lines = [
    ...
    '',
    'If it was something else, hit reply and tell me what stopped you. I read these myself, and knowing what did not work is worth more to me than the sale.',
    '',
    '--',
    BIO_NAME,
    BIO_TEXT,
  ...
  const content = `<tr><td align="left" style="padding:30px 40px 0 40px;">
      ...
      <tr><td align="left" style="padding:24px 40px 0 40px;">
        <p style="margin:0;font-family:${SANS};font-size:16px;line-height:1.65;color:${INK_SOFT};">If it was something else, hit reply and tell me what stopped you. I read these myself, and knowing what did not work is worth more to me than the sale.</p>
      </td></tr>
