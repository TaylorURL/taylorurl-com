...
import { block, line, notice } from './notice.js'
 ...
 *
 * A floor this ladder does not recognise is in none of these lists, so it
 * reaches nothing. The column's own CHECK makes that unreachable through the
 * database, and a comparison that silently treated an unknown value as the
 * lowest would mail a corrupt row everything rather than nothing.
 *
