 ...
 * `scripts/check-email-bio.js` renders all three families to prove each one
 * still draws it.
 */
...
export const BIO_TITLE = 'Software Engineer'
...
const STUDIO_BIO_TEXT =
  ...
  'full time. I now build and look after websites for business owners across Southeast ' +
  'Texas.'

const SECOND_SITE_BIO_TEXT =
  'I was a district manager. We needed software, so I built it. I left that job to do this ' +
  'full time. I now build software to order, repair conversion tracking, and run outbound ' +
  'email for companies that need one of the three.'
