...
export function groundOpener(prospect, where) {
  ...
  return {
    ...
    after: [
      `A site of your own is an address you keep whatever the platform does next, with your hours, your number and your work laid out the way you want them. It's most of what I build for small businesses ${where}.`,
