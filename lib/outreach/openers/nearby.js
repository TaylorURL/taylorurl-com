...
export function nearbyOpener(prospect, where, shot, context = {}) {
  ...
  return {
    subject: context.prior?.subject
      ...
      : `A site I built near ${prospect.town || 'you'}`,
    marker: '// Nearby Work',
    lines: [
      project
        ? `One more from me, then I'll leave it with you. The first site below is one I built for ${project.name} in ${project.place}, the closest thing to your line of work I have live.`
        : `One more from me, then I'll leave it with you. Below are a few of the sites I have live for businesses ${where}.`,
    ],
    figure: null,
    after: [
      project?.review
