...
export function introductionOpener(prospect, where) {
  return plainLetter(SUBJECT, [
    `This is only an introduction. There's nothing to buy in it and nothing to sign up for. I'm Trenton Taylor, and I build and look after websites for businesses ${where}.`,
    `One email a month is all I send you: no newsletters, no offers, nothing else. If you'd rather not have it, the link at the bottom takes this address off for good.`,
    `I just want to be top of mind if you ever need help getting more customers.`,
  ])
}
