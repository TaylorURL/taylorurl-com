 ...
 *
 * It does not say "we haven't heard back" or anything near it. Naming the
...
export function plainLastOpener(prospect, where, shot, context = {}) {
  return plainLetter(threaded(context, 'last note from us'), [
    `We'll take the quiet as an answer, so this is the last one from us.`,
    `If it's any use, reply with a number:\n1. Yes, tell me more.\n2. Not now, check back in a few months.\n3. No, and take me off.`,
    `Nothing back is an answer too, and we'll leave it there.`,
