...
export function plainListingOpener(prospect, where, shot, context = {}) {
  ...
  return plainLetter('your google listing', [
    ...
    [
      `A site of your own is one page with your number at the top, your hours, your work and a way to ask for a quote, at an address that stays yours. I build them for small businesses ${where}.`,
      workLine(context),
    ]
      .filter(Boolean)
      .join(' '),
