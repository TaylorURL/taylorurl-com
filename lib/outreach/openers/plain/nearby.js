...
export function plainNearbyOpener(prospect, where, shot, context = {}) {
  ...
  const opening = !project
    ? `One more from me, then I'll leave it with you. I have a few sites live for businesses ${where}, each on the business's own address.`
    : sharesTrade(project, prospect.trade)
      ? `One more from me, then I'll leave it with you. ${project.name} in ${project.town || project.place} is the closest thing to your line of work I have live.`
      : `One more from me, then I'll leave it with you. ${project.name} in ${project.town || project.place} is one of the sites I have live near you.`
