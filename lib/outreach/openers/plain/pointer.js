...
export function pointerOpener(prospect, where, shot, context = {}) {
  ...
  return plainLetter(threaded(context, 'wrong person?'), [
    ...
    `Either way, is there somebody ${near} who's been meaning to do something about their website? I'd rather be pointed at one person who needs it than write to fifty who don't.`,
    context.site
