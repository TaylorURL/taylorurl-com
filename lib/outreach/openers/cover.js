...
export function coverOpener(prospect, where, shot, context = {}) {
  ...
  return {
    ...
    lines: [
      `I wrote a few days ago about your listing pointing at a page on somebody else's platform. Here's the short version of what a site of your own would cover.`,
    ],
    figure: null,
    after: [
      ...
      `Built to be found by somebody searching for what you do, not just for your name. That's most of what I build for small businesses ${where}.`,
