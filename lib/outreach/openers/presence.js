...
export function siteOpener(prospect, where) {
  ...
  return {
    ...
    marker: '// Web Presence',
    lines: [
      `We went looking for your website this week. The only thing your listing points at is a page on somebody else's platform.`,
    ],
    figure: {
      label: 'Your Listing',
      meta: 'Platform',
    ...
    after: [
      `A site of your own puts the people searching for you on a page you control, with your hours, your number and your work on it. That's most of what we do for small businesses ${where}.`,
