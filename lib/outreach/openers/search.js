...
import { GOOD_FLOOR, bandOf, supporting, verify } from '../audit/bands.js'
...
export function searchVerdict(score) {
...
export function searchOpener(prospect, where, shot) {
  ...
  return {
    ...
    lines: [
      score === null
        ? `I ran ${name}'s website through Google's report this week. Speed is the figure most people quote from it, but it also grades whether a page tells Google plainly what you do and where you are, and it couldn't put a number on yours.`
    ...
    after: [
      `Most of what it marks is a short job: a title, a description, links it can follow. Fixed, the people searching for what you do find you instead of the next name down. It's most of what I do for small businesses ${where}.`,
