...
export const IN_PERSON =
  "If you'd rather go through it in person once a build is underway, we’ll come to you. Nobody hands you a login and leaves you to it."
...
export const OFFER = what =>
  `Want ${what}? Reply and we’ll send it over. No charge, and no sales call attached.`
