...
function listingLine(row) {
  ...
  if (presence === 'none') {
    return (
      ...
      'website. Anybody who wants your hours or your prices has to ring you to find out.'
    )
  }
  if (presence === 'portal') {
    return (
...
const ASK =
  ...
  'at no charge and with the number agreed before anything starts. Have you got ten minutes ' +
  'this week?'
  ...
  return [
    ...
    },
    {
      ...
      say:
        ...
        'Baytown and Houston. I am not selling anything over the phone, I rang about something ' +
...
export const PUSHBACK = Object.freeze([
  ...
  },
  {
    ...
    say:
      ...
      'types it into their phone before they ring, and right now what they find is a map pin.',
...
export const CLOSING = Object.freeze([
  ...
  },
  {
    ...
    say:
      'They get a written plan and a price by email at no charge. Read it, and if the number ' +
      'works we start.',
  },
  {
    id: 'record',
