 ...
 * caller who contradicts the last one by Tuesday. A build is worked out for the
 * job it is, so the answer to what it costs is how the number gets settled
 * rather than a number, and no figure is said down the phone at all.
 *
 ...
 * full stop.
 *
 * No figure is said. A build is worked out for the job it is, so what a caller
 * gives back is how the number gets settled and when they will have it.
 */
export const QUESTIONS = Object.freeze([
  {
    ...
    say:
      ...
      'read it off a list. Tell me what you need it to do and you get a written plan with the ' +
      'figure on it the same day. Nothing is charged for that.',
  },
  {
    id: 'monthly',
...
export const PUSHBACK = Object.freeze([
  ...
  },
  {
    ...
    say:
      'Fair enough. Nothing is settled yet, and the number comes once I know what the site has ' +
      'to do. The question first is whether one extra job a month would cover it.',
    after:
...
export const CLOSING = Object.freeze([
  ...
  },
  {
    ...
    say: 'Send the plan the same day. The studio sends the payment link once they agree to it.',
  },
])
