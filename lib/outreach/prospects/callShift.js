 ...
 * count Call Mode carries is a count of what is left.
 *
 ...
 */
export const REACHED_OUTCOMES = Object.freeze(['spoke', 'callback', 'booked', 'not_interested'])

/** Whether an outcome means somebody who could buy a website was on the line. */
export function callReachedOwner(outcome) {
