...
export const CALL_OUTCOMES = Object.freeze([
  ...
  { id: 'gatekeeper', label: 'Gatekeeper', tone: 'plain', track: 'held', key: '3' },
  { id: 'spoke', label: 'Spoke To Owner', tone: 'accent', track: 'reached', key: '4' },
  { id: 'callback', label: 'Call Back', tone: 'accent', track: 'reached', keeps: true, key: '5' },
  { id: 'booked', label: 'Booked', tone: 'good', track: 'off', ends: true, key: '6' },
  {
    id: 'not_interested',
 ...
 * trade is the strongest opener a one-person studio has, and it is also a fact
