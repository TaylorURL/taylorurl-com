 ...
 *
 * The order itself is not decided here either. lib/outreach/rank.js holds the
...
import { YOUNG_REVIEW_CEILING } from './youth.js'
 ...
 *
 * Four times DAILY_CAP_MAX, which is above the entire eligible table as it
 ...
 * keep out.
 */
export const PRIORITY_LIMIT = 600
 ...
 * ceiling moved in lib/outreach/youth.js moves this read with it.
 *
 ...
 */
export const AHEAD_OF_SCORE_FILTER = [
  'site_kind.eq.social',
 ...
 * reads is in lib/outreach/rank.js rather than restated here: a business that
...
export function queueFor({
  ...
  const queue = candidates.filter(prospect => {
    ...
    // lib/outreach/exclusions.js drop a listing Google has closed for good and
