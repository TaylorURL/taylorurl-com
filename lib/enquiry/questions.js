...
export const QUESTIONS = {
  ...
  //
  // Unlike the contact page it asks which service the work is, off the same
  // list the Services menu reads, and which of the extras the sender wants
  // with it, because this page takes enquiries for apps and software as well
  // as sites.
  start: {
    name: NAME,
    company: IS_SECOND_SITE ? 'Company name' : 'Business name',
    ...
    phone: REPLY_QUESTIONS.phone,
    contactMethod: REPLY_QUESTIONS.contactMethod,
    projectType: 'What you need built',
    addOns: 'Add-ons',
    message: 'What the project has to do',
  },
}
