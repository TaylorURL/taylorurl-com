...
export const QUESTIONS = {
  ...
  // The Start page asks the same four things the contact page asks, of somebody
  // who arrived ready to begin, so the words are the contact page's own rather
  // than a second set that could drift from them. What separates the two is the
  // form name, which is what the figures read.
  //
  // The reply-method pair is absent because the form does not put it. Somebody
  // who has just written a paragraph about their business is answered by email,
  // and asking them how they would like to be phoned is friction the page
  // exists to avoid.
  start: {
    name: NAME,
    email: EMAIL,
