...
import { TRUSTPILOT_DATA_URL } from '../../src/app/data/reputation/trustpilot.js'
import { STANDING_MAX_AGE_DAYS } from '../../src/app/data/reputation/trustpilot-standing.js'
import { dayIn } from '../../lib/time/zone.js'

const target = new URL('../../src/app/data/reputation/trustpilot-standing.js', import.meta.url)
