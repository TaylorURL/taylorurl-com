 ...
 *
 *   node scripts/blog-variation.js                     every published article against every other
 *   node scripts/blog-variation.js --distribution      the pairwise spread the bar is read from
 *   node scripts/blog-variation.js --candidate <file>  a draft against everything published
 *   node scripts/blog-variation.js --self-test         the cases the measure has to get right
 *
