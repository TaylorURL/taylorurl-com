...
reads as an oversight.
    ...
    python3 scripts/console/capture-site-icons.py            # every site in the list
    python3 scripts/console/capture-site-icons.py --check    # report, write nothing
...
def hosts():
    ...
    source = ROOT / "src" / "app" / "data" / "console" / "siteIcons.js"
    if source.exists():
...
def main():
    ...
    if not targets:
        print("no hosts given and none listed in src/app/data/console/siteIcons.js")
        return 1
    ...
    if grounds:
        print("\nDARK_GROUND, for src/app/data/console/siteIcons.js:")
