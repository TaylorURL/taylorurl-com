...
import { CLIENT_REVIEWS, reviewSource } from '../src/app/data/reviews.js'
import { TRUSTPILOT_STANDING } from '../src/app/data/trustpilot-standing.js'
...
const card = readFileSync(
  new URL('../src/app/components/ClientTestimonialCard.jsx', import.meta.url),
  'utf8'
)
...
for (const page of ['components/ReviewCarousel.jsx', 'views/CaseStudy.jsx']) {
  const source = readFileSync(new URL(`../src/app/${page}`, import.meta.url), 'utf8')
  if (!/import ClientTestimonialCard from '@components\/ClientTestimonialCard'/.test(source)) {
