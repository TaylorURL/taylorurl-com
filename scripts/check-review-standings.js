...
import { BBB_SEAL_SRC, bbbAccredited } from '../src/app/data/bbb.js'
import { REVIEW_SOURCES, reviewSource } from '../src/app/data/reviews.js'
import {
  REVIEW_STANDINGS,
  REVIEW_STANDING_MAX_AGE_DAYS,
  committedStandings,
  standingShows,
} from '../src/app/data/review-standings.js'
...
const badge = readFileSync(
  new URL('../src/app/components/ReviewStandingBadge.jsx', import.meta.url),
  'utf8'
)
