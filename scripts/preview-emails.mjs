 ...
 *
 * Usage:
 *   node scripts/preview-emails.mjs --dry-run [--out DIR]
 *   node scripts/preview-emails.mjs --to first@example.com --only outreach-speed
 *   node scripts/preview-emails.mjs --to first@example.com --issue <uuid>
 *   node scripts/preview-emails.mjs --to first@example.com --to second@example.com
 *   node scripts/preview-emails.mjs --to first@example.com --asset-origin https://build.vercel.app
 *
 ...
 *     taylorurl-resend-api-key=RESEND_API_KEY -- node scripts/preview-emails.mjs --to first@example.com
 *
