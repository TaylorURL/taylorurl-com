 ...
 *
 * `scripts/portfolio-sites.json` holds the domains deliberately absent from the
...
async function main() {
  const registry = JSON.parse(await readFile(resolve(ROOT, 'scripts/portfolio-sites.json'), 'utf8'))
