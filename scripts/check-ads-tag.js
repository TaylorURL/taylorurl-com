...
import { adsSendTo } from '../src/app/data/conversion.js'
import { counted } from '../src/app/views/analytics/lib/counted.js'

const TEMPLATE = readFileSync(new URL('../index.html', import.meta.url), 'utf8')
const PRIVACY = readFileSync(new URL('../src/app/views/Privacy.jsx', import.meta.url), 'utf8')
...
const LAYOUT = readFileSync(new URL('../src/app/components/Layout.jsx', import.meta.url), 'utf8')
