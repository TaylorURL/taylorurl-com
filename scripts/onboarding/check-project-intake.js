...
const HOOK = 'src/app/hooks/console/useProjectFeed.js'
const ASKS = 'src/app/views/console/intake/ProjectAsks.jsx'
const DOCK = 'src/app/views/console/intake/ProjectChecklist.jsx'
const PAGE = 'src/app/views/console/pages/health/ProjectPage.jsx'
